...
<div id="foruminfo">
	<div id="nav">
		<a href="${config.forumurl}" class="home">${config.forumtitle}</a>  &raquo; <a href="usercp.action">用户中心</a>  &raquo; <strong>积分收入记录</strong>
	</div>
	<div id="headsearch">
		<div id="search">
			<@comm.quicksearch/>
				...
				<div class="pannelbody">
					...
					<#if reqcfg.page_err==0>
						...
						<div class="pages_btns">
							...
							window.location='usercpcreditspayinlog.action?page=' + this.value;}"  size="4" maxlength="9"/>页</kbd>
							</div>
						</div>
						</#if>
					<#else>
