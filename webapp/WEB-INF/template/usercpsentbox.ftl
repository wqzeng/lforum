...
<div id="foruminfo">
	<div id="nav">
		<a href="${config.forumurl}" class="home">${config.forumtitle}</a>  &raquo; <a href="usercp.action">用户中心</a>  &raquo; <strong>发件箱</strong>
	</div>
	<div id="headsearch">
		<div id="search">
			<@comm.quicksearch/>
				...
				<div class="pannelbody">
					...
					<#if reqcfg.page_err==0>
						...
						<tbody>
							...
							<td width="3%"><img src="templates/${templatepath}/images/message_${pm.new_}.gif" /></td>
							<td width="4%"><input name="pmitemid" id="id${pm.pmid}" type="checkbox" id="pmitemid" value="${pm.pmid}" style="margin-top:-1px;"/></td>
							...
							<td><a href="#" onclick="$('id${pm.pmid}').checked=true;$('pmform').submit();">删除</a></td>
							</tr>
						</tbody>
						</#list>
						</table>
						...
						<div class="pannelmessage">
									<div class="pannelleft" style="width: 160px;">
										<a href="javascript:;"  onclick="checkCheckBox($('pmform'),this)" class="selectall">全选</a>
						...
						<div class="pages_btns">
							...
							window.location='usercpsentbox.action?page=' + this.value;}"  size="4" maxlength="9"/>页</kbd>
							</div>
						</div>
						</#if>
					<#else>
