...
<body>
    <form id="Form1" method="post">
     ${htmlBuilder}
	    ...
	    <tr>
        <td>	
	    <@c.tabControl id="TabControl1" tabScriptPath="../js/tabstrip.js" height="100%" default="tabPage51">
		    <@c.tabPage caption="基本信息" id="tabPage51" tabid="TabControl1" default="tabPage51"/>
		    <@c.tabPage caption="高级设置" id="tabPage22" tabid="TabControl1" default="tabPage51"/>
		    <@c.tabPage caption="权限设定" id="tabPage33" tabid="TabControl1" default="tabPage51"/>
		</@c.tabControl>
		<div id="TabControl1tabarea" class="tabarea">
		    <@c.tabItem tabid="TabControl1" id="tabPage51" default="tabPage51">
                ...
                <td  class="panelbox" align="left" width="50%">
                    <table width="100%">
                        <tr>
						    ...
						    <td>
							    <@c.textBox id="name" required="true" size="20"  maxlength="49"></@c.textBox>
							</td>
                        </tr>
                        <tr>
						    <td>显示模式:</td>
						            ...
						            <tr>
						                <td>
						                    <@c.radioButtonList id="colcount"  hintTitle="提示" repeatColumns="1" 
								                ...
								                <@c.radioItem name="colcount" id="colcount1" value="1" checked="1">传统模式[默认]</@c.radioItem ></td></tr><tr><td>
								                <@c.radioItem name="colcount" id="colcount2" value="2" checked="1">子版块横排模式</@c.radioItem ></td></tr>
							                </@c.radioButtonList>
						                </td>
					                    <td valign=bottom>
			 		    	                <div id="showcolnum" style="display:none">
			 		    	                <@c.textBox id="colcountnumber" width="50" size="2" value="4" maxlength="1"></@c.textBox>
			 		    	                </div>
			 		                   </td>
			 		               </tr>
			 		           </table>
					    ...
					    <tr>
						    ...
						    <td>
						        <table>
						          <tr>
						            <td>
								        <@c.radioButtonList id="addtype"  repeatColumns="1"
								        onclick="javascript:document.getElementById('showtargetforum').style.display= (document.getElementById('addtype0').checked ? 'none' : 'block');">
								        <tr><td><@c.radioItem name="addtype" id="addtype0" value="0" checked="1">论坛分类</@c.radioItem>
								        <@c.radioItem name="addtype" id="addtype1" value="1" checked="1">论坛版块</@c.radioItem></td></tr>
								        </@c.radioButtonList>
							        </td>
							      </tr>
							      <tr>	
							        <td>
								        &nbsp;&nbsp;
								        <div id="showtargetforum" style="display:block">
								        	<@c.dropDownList id="forumid">
								        		<option selected="selected" value="1">请&#160;选&#160;择</option>
								        		${forumTree?default("")}
								        	</@c.dropDownList>
								        </div>
								    </td>
			...
			<@c.tabItem tabid="TabControl1" id="tabPage22" default="tabPage51">            
            <table cellspacing="0" cellpadding="4" width="100%" align="center">
            <tr>
                <td  class="panelbox" align="left" width="50%">
                    <table width="100%">
	...
	<tr>
		...
		<td><input id="setting_3" type="checkbox" name="Allowimgcode" value="1"/><label for="setting_3">允许[img]代码</label></td><td><input id="setting_7" type="checkbox" name="Disablewatermark " value="1" /><label for="setting_7">禁止附件自动水印</label></td><td></td><td></td>
			...
			<@c.tabItem tabid="TabControl1" id="tabPage33" default="tabPage51">               
		      ...
		      <div id="topictypes" style="display:none;width:100%;">
		           <table>
					    ...
					    <tr>
						    <td>模板风格:</td>
						    <td>
							    <@c.dropDownList id="templateid"></@c.dropDownList></td>
					    </tr>
				    </table>
			       </div>
		    <div class="Navbutton">
