    ...
    <head id="Head1">
		...
		this.init = function(){
			...
			for(i=0;i<treeNodes.length;i++){
				...
				{
				     document.write("onmousedown=\"" + this.id + ".onmousedown(event);\" onmouseup=\"" + this.id + ".onmouseup(event);\" onmouseover=\"" + this.id + ".onmouseover(event)\" onmouseout=\"" + this.id + ".onmouseout(event)\">" + treeNodes[i].subject + (treeNodes[i].istrade == 1 ? "<span style='color:#f00;font-weight:bold;'>(交易版)</span>" : "") + " &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=../images/cal_nextMonth.gif> &nbsp;<a href=\"#\" class=\"TopicButton\"  type=\"button\" onclick=\"javascript:window.location.href='forum_addforums.action?fid="+treeNodes[i].fid+"';\"><img src=\"../images/add.gif\"/>添加</a><a href=\"#\" class=\"TopicButton\" type=\"button\" onclick=\"javascript:window.location.href='" + (treeNodes[i].istrade == 1 ? "forum_editmall" : "forum_editforums") + ".action?fid="+treeNodes[i].fid+"';\"><img src=\"../images/submit.gif\"/>编辑</a><a href=\"#\" class=\"TopicButton\" type=\"button\" onclick=\"javascript:if(confirm('您要删除该项吗?')){success.style.display = 'block';HideOverSels('success');window.location.href='forum_delforums.action?fid="+treeNodes[i].fid+"';}\"><img src=\"../images/del.gif\" />删除</a><a href=\"#\" class=\"TopicButton\" type=\"button\" onclick=\"javascript:window.location.href='forum_forumsmove.action?currentfid="+treeNodes[i].fid+"';\"><img src=\"../images/move.gif\"/>移动</a></div>");
				}
				else
				{
				     document.write("onmousedown=\"" + this.id + ".onmousedown(event);\" onmouseup=\"" + this.id + ".onmouseup(event);\" onmouseover=\"" + this.id + ".onmouseover(event)\" onmouseout=\"" + this.id + ".onmouseout(event)\">" + treeNodes[i].subject + (treeNodes[i].istrade == 1 ? "<span style='color:#f00;font-weight:bold;'>(交易版)</span>" : "") + " &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=../images/cal_nextMonth.gif>&nbsp;<a href=\"#\" class=\"TopicButton\" type=\"button\" onclick=\"javascript:window.location.href='forum_addforums.action?fid="+treeNodes[i].fid+"';\"><img src=\"../images/add.gif\"/>添加</a><a href=\"#\" class=\"TopicButton\" type=\"button\" onclick=\"javascript:window.location.href='" + (treeNodes[i].istrade == 1 ? "forum_editmall" : "forum_editforums") + ".action?fid="+treeNodes[i].fid+"';\"><img src=\"../images/submit.gif\"/>编辑</a><a href=\"#\" class=\"TopicButton\" type=\"button\" onclick=\"javascript:if(confirm('您要删除该项吗?')){success.style.display = 'block';HideOverSels('success');window.location.href='forum_delforums.action?fid="+treeNodes[i].fid+"';}\"><img src=\"../images/del.gif\" />删除</a><a href=\"#\" class=\"TopicButton\" type=\"button\" onclick=\"javascript:window.location.href='forum_forumsmove.action?currentfid="+treeNodes[i].fid+"';\"><img src=\"../images/move.gif\" />移动</a><a href=\"#\" class=\"TopicButton\" type=\"button\" onclick=\"javascript:window.location.href='forum_editforums.action?fid="+treeNodes[i].fid+"&tabindex=3';\"><img src=\"../images/topictype.gif\"/>特殊用户</a><a href=\"#\" class=\"TopicButton\" type=\"button\" onclick=\"javascript:window.location.href='forum_editforums.action?fid="+treeNodes[i].fid+"&tabindex=4';\"><img src=\"../images/topictype.gif\"/>主题分类</a><a href=\"#\" class=\"TopicButton\" type=\"button\" onclick=\"javascript:window.location.href='forum_forumbatchset.action?fid="+treeNodes[i].fid+"';\"><img src=\"../images/nav/guide.gif\"/>复制论坛设置</a></div>");
				}
			}
	    ...
	    function reSetTree(objN,objO,treetype){
		    ...
		    { 
		       ...
		       if(confirm(message))
		       {
		          ...
		          //alert(objnparentidlist);
		          if(objnparentidlist.indexOf(','+objO.fid+',')<0)
		          {
		             //alert('可以移动');
		             success.style.display = 'block';
		             HideOverSels('success');
		             window.location.href='forum_forumstree.action?currentfid='+objO.fid+'&targetfid='+objN.fid+'&isaschildnode='+treetype;
	              }
	              else
	              {
    ...
    <body style="overflow:scroll;">
        ...
        ${htmlBuilder}
            <div style="clear:both;position:relative">
                ...
                text="<li>支持鼠标拖拽</li><li>如需批量设置版块,请设置完一个版块后选择&quot;复制论坛设置&quot;</li>" />
                <div class="Navbutton" style=" margin:0 auto; text-align:center;">
	                <table width="100%">
		                <tr>
			                <td width="100%">
				                <span id="ShowTreeLabel">
				                ${treeStr}
 								</span>
			                </td>
		                </tr>
