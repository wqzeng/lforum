...
<head>
    ...
    <title>LForum|论坛 管理后台 - LForum - Powered by LForum For Java</title>
	<meta name="keywords" content="JAVA,论坛" />
	<meta name="description" content="LForum,论坛,java" />
	...
	<script type="text/javascript">
        ...
        function LoadJs()
        {
            ...
            script.type = "text/javascript"; script.src = "navmenu.js"; script.id = "jsfile";
        ...
        function ShortcutMenuContent()
        {
            ...
            shortcutmenustr += '<dd><a href="javascript:void(0);" onclick="javascript:top.location.href=\'../../main.action\';" onfocus="this.blur();">返回前台</a></dd>';
            shortcutmenustr += '<dd><a href="javascript:void(0);" onclick="javascript:document.getElementById(\'main\').src=\'../rapidset/shortcut.action\';" onfocus="this.blur();" >常用操作</a></dd>';
            shortcutmenustr += '<dd><a href="javascript:void(0);" onclick="javascript:document.getElementById(\'main\').src=\'../rapidset/systeminf.action\';" onfocus="this.blur();" >系统信息</a></dd>';
            shortcutmenustr += '<dd><a href="javascript:void(0);" onclick="javascript:document.getElementById(\'main\').src=\'../rapidset/setting.action\';" onfocus="this.blur();" >快速设置向导</a></dd>';
            shortcutmenustr += '<dd><a href="javascript:void(0);" onclick="javascript:document.getElementById(\'main\').src=\'../rapidset/likesetting.action\';" onfocus="this.blur();" >个人喜好设置</a></dd>';
            shortcutmenustr += '<dd><a href="javascript:void(0);" onclick="javascript:document.getElementById(\'main\').src=\'../rapidset/managemainmenu.action\';" onfocus="this.blur();" >管理功能菜单</a></dd>';
            shortcutmenustr += '<dd><a href="javascript:void(0);" onclick="javascript:document.getElementById(\'main\').src=\'../rapidset/manageshortcutmenu.action\';" onfocus="this.blur();" >管理快捷菜单</a></dd>';
            shortcutmenustr += '<dd><a href="http://lonlysky.javaeye.com" target="_blank" onfocus="this.blur();">帮助</a></dd>';
            shortcutmenustr += '<dd><a href="javascript:void(0);" onclick="javascript:top.location.href=\'../logout.action\';" onfocus="this.blur();" >退出</a></dd>';                
        ...
        function  Search(searchinf,searchtype)
        {
           ...
           AjaxProxyUrl = new String("../ajax.action");
           switch(searchtype)
           {
              case 'function':
              {
    ...
    <script type="text/javascript">
        ...
        function gotoShortcut()
        {
            BOX_remove('setting');
            window.parent.frames[0].BOX_remove('setting');
            document.getElementById("main").src="../rapidset/manageshortcutmenu.action";
        }
