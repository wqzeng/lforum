		...
		<ul id="MainMenu">
		    <li class="MenuDrop">
		        <div class="MenuDropOut" onmouseover="this.className='MenuDropOn'" onmouseout="this.className='MenuDropOut'">
		            <a href="" onmouseover="javascript:top.mainFrame.setshorcutmenu('block');" onmouseout="javascript:top.mainFrame.setshorcutmenu('none');" >快捷操作</a>
		        </div>
		    </li>
		</ul>		
		<div class="SearchBar">
...
<script type="text/javascript">
    ...
    function locationurl(showmenuid,toptabmenuid, mainmenulist,defaulturl)
    {
       ...
       //alert(defaulturl);
       top.mainFrame.location.href='../framepage/managerbody.action?showmenuid='+showmenuid+'&toptabmenuid='+toptabmenuid+'&mainmenulist='+mainmenulist+'&defaulturl='+defaulturl;
