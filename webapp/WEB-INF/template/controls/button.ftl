<#-- 
	...
	版本：v1.0 
-->
<#macro button id text buttonImgUrl="../images/submit.gif" hintTitle="" scriptContent="" hintInfo="" type="submit" method="" enabled="false">
...
<button type="${type}" <#if enabled=="true">disabled="true"</#if> class="ManagerButton" id="${id}" name="${id}" value="${id}"
	onclick="this.disabled=true;document.getElementById('success').style.display = 'block';HideOverSels('success');doPost('${method}');${scriptContent}"><img
