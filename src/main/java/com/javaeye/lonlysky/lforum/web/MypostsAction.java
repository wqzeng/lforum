...
public class MypostsAction extends ForumBaseAction {

	private static final long serialVersionUID = 8159656663159381277L;
	...
	public String execute() throws Exception {
		...
		//获取主题总数
		topiccount = topicManager.getTopicsCountbyReplyUserId(userid);
		//获取总页数
		...
		this.topics = topicManager.getTopicsByReplyUserId(userid, pageid, pagesize, 600, config.getHottopic());

		pagenumbers = ForumUtils.getPageNumbers(pageid, pagecount, "myposts.action", 8);
		return SUCCESS;
	}
