...
public class UsercpsentboxAction extends ForumBaseAction {

	private static final long serialVersionUID = 4139240963051553937L;
	...
	private void bindItems() {
		...
		//获取主题总数
		pmcount = messageManager.getPrivateMessageCount(userid, 1);
		//获取总页数
		...
		pmlist = messageManager.getPrivateMessageList(userid, 1, 16, pageid, 2);
		pagenumbers = ForumUtils.getPageNumbers(pageid, pagecount, "usercpsentbox.action", 8);
	}
